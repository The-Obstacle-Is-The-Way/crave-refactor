    ...
    func store(_ event: any AnalyticsEvent) async throws { // Use protocol type 'any AnalyticsEvent'
        if let cravingEvent = event as? CravingEvent {
            ...
            // TODO: Store UserEvent data if needed
             ...
             modelContext.insert(InteractionData(cravingId: interactionEvent.cravingId, timestamp: interactionEvent.timestamp, interactionType: interactionEvent.interactionType)) //Example, adjust as needed
        } else {
