...
//
//  🍒
//  CRAVEApp/Analytics/Services/AnalyticsService.swift
...
extension AnalyticsStorage {
    static func preview() -> AnalyticsStorage {
        let container = try! ModelContainer(for: CravingModel.self, AnalyticsMetadata.self, InteractionData.self, ContextualData.self, configurations: ModelConfiguration(isStoredInMemoryOnly: true)) // Include ALL your model types
